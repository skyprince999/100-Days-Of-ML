...
class DutchSocial(datasets.GeneratorBasedBuilder):
    ...
    BUILDER_CONFIGS = [
        datasets.BuilderConfig(
            name="dutch_social", version=VERSION, description="This part of my dataset provides config for the entire dataset"
        )
        ...
        with open(filepath, encoding="utf-8") as f:
            ...
            for id_, data in enumerate(tweets):
                yield id_, {
                        ...
                        "hisco_standard": " "
                        if not isinstance(data["hisco_standard"], str)
                        else data["hisco_standard"],
